...
use ProsusPay\Result\AbstractStorePaymentMethodResult;
use ProsusPay\Result\StorePaymentMethodCollection;
...
class StorePaymentMethod extends AbstractClient
{
    ...
    {
        $className = '\ProsusPay\Client\StorePaymentMethod' . $paymentType;
